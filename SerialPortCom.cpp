...
bool SerialPortCom::openPort(string port_name, int baud_rate = 9600)
{
	DCB dcb;
	_hComm = CreateFile( TEXT("COM5"),
	...
	if(_hComm == INVALID_HANDLE_VALUE){
		cout << "openPort: _hComm == INVALID_HANDLE_VALUE   error accur:" <<port_name<< endl;
		return false;
	}
...
bool SerialPortCom::writePort(string str)
{
