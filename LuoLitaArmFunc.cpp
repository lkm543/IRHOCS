...
float RV_percentage = 15.0f;
float RA_percentage =  10.0f;
...
void init_LuoLita_1()
{
	...
	LinSpeed = 0.02f*LV_percentage * 0.001f*LVmax/10.0f;  ///0.02
	AngSpeed = 0.01f*RV_percentage * deg2rad*RVmax/10.0f; ///0.01
	...
	Lin_Vel_limit_default = ( 0.03f*LV_percentage * 0.001f*LVmax / 1000.0f ) *SAMPLING_TIME_C;
	Lin_Acc_limit_default = ((0.03f*LA_percentage * 0.001f*LAmax / 1000.0f ) *SAMPLING_TIME_C) /1000 *SAMPLING_TIME_C;
...
void init_LuoLita_2()
{
	...
	// Speed up	
	Lin_Vel_limit = ( 0.01f*150 * 0.001f*LVmax / 1000.0f ) *SAMPLING_TIME_C;
	Lin_Acc_limit = ((0.01f*150 * 0.001f*LAmax / 1000.0f ) *SAMPLING_TIME_C) /1000 *SAMPLING_TIME_C;
