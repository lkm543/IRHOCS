...
const float gain_FT_p_fric[USAGE_CHANNELS] = {1.0f, 1.1f, 0.1f, 0.8f, 0.9f, 0.9f, 0.6f}; //老大說：調整二四軸讓teach上下的力相同，這是向上
const float gain_FT_n_fric[USAGE_CHANNELS] = {1.0f, 1.1f, 0.1f, 0.8f, 0.9f, 0.6f, 0.6f}; //老大說：調整二四軸讓teach上下的力相同，這是向下 0.5 0.1
